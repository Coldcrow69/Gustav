...
A set of **five hooded cloaks**, hand-prepared by **[[Seren Moss]]** as **parting gifts to the party** prior to their departure from [[Fort Elm]] for [[Bluefield Burning]] (the morning of 9/25/25). The cloaks are listed in [[Bluefield Burning]] Session 1 as *"thick winter cloaks for everyone"*; each is matched to its recipient by style and color.

> **Recipients**: [[Bell]], [[Eldrin Thalor]], [[Lyrion Thalor]], [[Mike]], [[Rhaenyra]].
> **Not in the set**: Seren herself, [[Thorn]], [[Teron]] (Teron had already departed the party).
...
The cloak image files were delivered in `Raine's Crypt Keeper Drip.zip`. To make the embeds above render in Obsidian, place the PNGs in the vault's `Attachments/` folder (locally: `Z:\User\Documents\Obsidian\Gustav\Attachments\`) keeping the exact filenames shown above (`Cloak - Bell.png`, `Cloak - Eldrin.png`, `Cloak - Lyrion.png`, `Cloak - Michael.png`, `Cloak - Miranda.png`).
