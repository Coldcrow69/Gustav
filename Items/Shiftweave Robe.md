...
A **magical robe** carried by [[Lyrion Thalor|Lyrion]]. The garment cycles between **five distinct configurations** when commanded — same fabric, same fit, completely different look.

## Command word

**"Curious."** Spoken by Lyrion — a **normal part of his vocabulary**, which makes the activation effectively invisible to anyone unfamiliar with the robe. Lyrion can prompt a shift mid-thought without breaking conversation.

## Provenance

Held by [[Lyrion Thalor|Lyrion]]. Source not yet recorded in vault notes.

## The five configurations

### Variant 1 — Wine velvet
...
The **tree motif** on variants 2 and 3 (single trunk, branches above only) is visually distinct from the [[Coin of Strange Iconography|crested coin]]'s symbol — *tree half-sprouted above ground, roots below*. **Not the same seal**, but worth keeping the comparison in mind if Lyrion ever needs to pass as a member of any tree-iconography order.
